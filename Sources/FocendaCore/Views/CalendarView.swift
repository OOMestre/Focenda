...
public struct CalendarView: View {
    ...
    private func calendarDayCell(day: CalendarDay) -> some View {
        ...
        .help("\(formattedFullDate(day.date)): \(day.focusMinutes)m focus, \(day.habitsCompletedCount) habits, \(day.tasksCount) tasks\(day.recurringRemindersCount > 0 ? ", \(day.recurringRemindersCount) recurring reminders" : "")")
    }
